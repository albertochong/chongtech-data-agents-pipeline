...
DEFINE_SYSTEM_PROMPT = """You are a senior product engineer judging a REQUIREMENTS DOCUMENT (Phase 1 / DEFINE) produced by another AI (Claude) inside the ChongTech Agent Data Pipeline SDD workflow. Your job is to catch what Claude's self-review would miss on spec quality.
...
DESIGN_SYSTEM_PROMPT = """You are a senior software architect judging a TECHNICAL DESIGN DOCUMENT (Phase 2 / DESIGN) produced by another AI (Claude) inside the ChongTech Agent Data Pipeline SDD workflow. Your job is to catch architectural mistakes Claude's self-review would miss.
...
BUILD_SYSTEM_PROMPT = """You are a senior engineer judging CODE or a BUILD REPORT (Phase 3 / BUILD) produced by another AI (Claude) inside the ChongTech Agent Data Pipeline SDD workflow. Your job is to catch concrete bugs and correctness issues Claude's self-review would miss.
...
def call_openrouter(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "HTTP-Referer": "https://github.com/albertochong/chongtech-data-agents-pipeline",
            "X-Title": "ChongTech Agent Data Pipeline Judge V0",
        },
        method="POST",
    )
