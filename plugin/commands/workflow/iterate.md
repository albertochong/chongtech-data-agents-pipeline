...
1. **Load the skill** — read `${CLAUDE_PLUGIN_ROOT}/skills/sdd-iterate/SKILL.md`; it owns the full
   methodology.
...
- Skill (methodology): `${CLAUDE_PLUGIN_ROOT}/skills/sdd-iterate/SKILL.md`
- Agent (executor): `${CLAUDE_PLUGIN_ROOT}/agents/workflow/iterate-agent.md`
