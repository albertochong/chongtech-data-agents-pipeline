...
Read `${CLAUDE_PLUGIN_ROOT}/skills/sdd-design/SKILL.md` and execute it end to end.
...
- Update the DEFINE status to "✅ Complete (Designed)" before finishing, per `${CLAUDE_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`.
