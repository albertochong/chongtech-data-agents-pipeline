...
Read `${CLAUDE_PLUGIN_ROOT}/skills/sdd-define/SKILL.md` and execute it. The skill owns the Phase 1 methodology end to end — input classification, entity extraction, technical and data engineering context gathering, clarity scoring against the 12/15 gate, gap filling, DEFINE document generation from `${CLAUDE_PLUGIN_ROOT}/sdd/templates/DEFINE_TEMPLATE.md`, and status transitions.
