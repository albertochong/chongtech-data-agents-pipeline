...
Read `${CLAUDE_PLUGIN_ROOT}/skills/sdd-brainstorm/SKILL.md` and execute it. That skill owns the methodology — question frameworks, quality gate, output format. This file owns only who executes and within what boundaries.
